        ...
        <el-form ref="form" :model="form" :rules="rules" label-width="180px" :inline="true">
            ...
            <el-form-item label="所属区域编码" prop="areaCode">
                <el-cascader v-model="form.areaCode" :options="areaOptions" clearable :props="{ expandTrigger: 'hover' }"
                    @change="handleChange" placeholder="请选择所属区域编码"></el-cascader>
            </el-form-item>
...
export default {
    ...
    created() {
        ...
        this.form.areaCode = this.form.areaCode ? this.form.areaCode.split('/') : undefined;
    },
    mounted() {
    ...
    methods: {
        ...
        submitForm() {
            ...
            this.$refs["form"].validate(valid => {
                if (valid) {
                    this.form.areaCode = this.form.areaCode ? this.form.areaCode.join('/') : undefined;
