<template>
    <div>
        <el-form ref="form" :model="form" :rules="rules" label-width="300px" :inline="true"
...
import { listLoadInfo, getLoadByUserId, getLoadInfo, delLoadInfo, addLoadInfo, updateLoadInfo } from "@/api/sc/loadInfo";
...
export default {
    ...
    methods: {
        ...
        getLoadInfo() {
            ...
            getLoadByUserId(params).then(response => {
                this.loading = false;
            });
        },
        /** 提交按钮 */
