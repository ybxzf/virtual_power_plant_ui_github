...
export default {
  ...
  methods: {
    ...
    // 绘制图表
    drawChart() {
      // this.myChart = echarts.init(document.getElementById("onGridEnergy"));
...
<template>
  <div class="onGridEnergy-container">
    <div id="onGridEnergy" ref="chartRef" v-if="chartData.xData.length"></div>
