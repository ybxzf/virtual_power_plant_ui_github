  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table border v-loading="loading" height="100%" :data="corporationList"
        ...
        &lt;!&ndash;      <el-table-column show-overflow-tooltip label="自增主键" align="center" prop="id" />&ndash;&gt;
...
&lt;!&ndash;        <el-table-column show-overflow-tooltip label="注册资金(万元)" align="center" prop="registeredCapital"
          min-width="120" />&ndash;&gt;
...
&lt;!&ndash;        <el-table-column show-overflow-tooltip label="合约生效日期" align="center" prop="contractStart" width="100">
          <template slot-scope="scope">
        ...
        <el-table-column show-overflow-tooltip label="所属虚拟电厂" align="center" prop="extend1" min-width="100" />&ndash;&gt;
