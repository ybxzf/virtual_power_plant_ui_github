...
export default {
  ...
  methods: {
    ...
    // 绘制图表
    drawChart() {
      // this.myChart = echarts.init(document.getElementById("levelProfile"));
        ...
        series: [
          {
            ...
            data: [
              { value: 10, name: '其他' },
              { value: 15, name: '交流380V' },
              { value: 75, name: '直流220V' },
            ]
          }
        ]
      };
...
<template>
  <div class="levelProfile-container">
    <div id="levelProfile" ref="chartRef" v-if="chartData.xData.length"></div>
