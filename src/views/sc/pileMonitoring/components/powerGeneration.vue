...
export default {
  ...
  methods: {
    ...
    // 绘制图表
    drawChart() {
      // this.myChart = echarts.init(document.getElementById("powerGeneration"));
...
<template>
  <div class="powerGeneration-container">
    <div id="powerGeneration" ref="chartRef" v-if="chartData.xData.length"></div>
