...
<!--      <el-form-item label="资产编号" prop="assetNo">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['sc:energyStorage:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['sc:energyStorage:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['sc:energyStorage:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['sc:energyStorage:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="energyStorageList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="储能名称" align="center" prop="storageName" />
      ...
      <el-table-column label="最大充电能力" align="center" prop="maxCharge" />
      <el-table-column label="最大放电能力" align="center" prop="maxDischarge" />
      <el-table-column label="所属回路ID" align="center" prop="circuitId" />
      <el-table-column label="主设备品牌和型号" align="center" prop="deviceModel" />
      <el-table-column label="充电提前通知时间" align="center" prop="chargeNotice" />
      <el-table-column label="日常放电时段" align="center" prop="dailyDischarge" />
      <el-table-column label="放电提前通知时间" align="center" prop="dischargeNotice" />
