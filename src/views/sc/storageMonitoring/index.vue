  ...
  data() {
    return {
      ...
      monitorList: [
        ...
        { label: "额定功率(MW)", value: '0.43', icon: "/img/icons/icon_2.png" },
        { label: "额定储电量(MWh)", value: '0.06', icon: "/img/icons/icon_3.png" },
        { label: "昨日最大充电负荷(MW)", value: '0.1', icon: "/img/icons/icon_4.png" },
        { label: "昨日最大放电功率(MW)", value: '0.19', icon: "/img/icons/icon_5.png" },
      ],
