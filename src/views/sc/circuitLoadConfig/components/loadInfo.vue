  ...
  <div v-loading="loading">
    ...
    <template v-else>
      <el-descriptions title="" :column="5" border>
        ...
        <el-descriptions-item label="保安负荷容量(KVA)">{{ form.securityLoad }}</el-descriptions-item>
...
<!--        <el-descriptions-item label="年用电量(kWh)">{{ form.annualElectricity }}</el-descriptions-item>
        ...
        <el-descriptions-item label="运行容量(KVA)">{{ form.runningCapacity }}</el-descriptions-item>
