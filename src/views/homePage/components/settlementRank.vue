      ...
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
        ...
        <div class="table-container">
            <el-table v-loading="loading" height="100%" ref="scrollTableRef" :data="corporationList" class="custom-table"
                ...
                <el-table-column show-overflow-tooltip label="统一社会信用代码" align="center" prop="creditCode"
                    min-width="150" />
        ...
        <pagination v-show="total > 0" small :total="total" :page.sync="queryParams.pageNum"
            :limit.sync="queryParams.pageSize" @pagination="getList" layout="total, prev, pager, next, jumper" />
    </div>
</template>
...
/* 如果需要同时设置表头高度 */
.custom-table .el-table__header tr,
